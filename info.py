...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [MovizTube™](https://telegram.me/MovizTube)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [MovizTube](https://t.me/MovizTube)</b> ↭  🔥")
...
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','Ultroidofficial') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','ultroidofficial')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "Movie_hunter12") #[ without @ ]
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'a63b677fe76af0fe0a31c727ac6b55366a7befe0')
...
DOWNLOAD_TEXT_URL = "https://telegram.me/Digital_Heaven_Team/6"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://telegram.me/MovizTube"
